...
<footer style="background: #fff;color: #000;">
    <div class="container">
        <div class="row dis-flex main-row-top-footer">
            ...
            <div class="col-md-4 text-center">
                <span class="footer_icons footer_icons2">14 Wall Street, 20th floor <br>Manhattan, 
                New York, 10005 </span>
            </div>
            <div class="col-md-4 text-center">
                <a href="tel:1-800-664-1945" style="color: #000;text-decoration: none;"><span class="footer_icons footer_icons3">Phone: 1-800-664-1945</span></a>
            </div>
        </div>
    </div>
    <div class="row container footer_bottom">
        ...
        <div class="col-md-6">
            <ul class="dis-flex list_footer_middle">
                ...
                <li><a href="https://www.outsourcedesigning.com/demo/faq/">FAQ</a></li>
            </ul>
        </div>
    </div>
